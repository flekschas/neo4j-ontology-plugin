...
@Description( "An extension to the Neo4j Server for getting dataset annotations" )
public class Annotations extends ServerPlugin
{
    @Description( "Get distribution of number of annotations per dataset" )
    @PluginTarget( GraphDatabaseService.class )
    public ListRepresentation getNumAnnoPerDataSet(@Source GraphDatabaseService db )
    {
